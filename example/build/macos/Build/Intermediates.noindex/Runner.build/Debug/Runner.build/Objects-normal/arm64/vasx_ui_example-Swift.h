...
#ifndef VASX_UI_EXAMPLE_SWIFT_H
#define VASX_UI_EXAMPLE_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="vasx_ui_example",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@class NSApplication;
SWIFT_CLASS("_TtC15vasx_ui_example11AppDelegate")
...
SWIFT_CLASS("_TtC15vasx_ui_example17MainFlutterWindow")
